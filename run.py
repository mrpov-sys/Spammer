...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print ("\033[1;37m[\033[1;30m1\033[1;37m] \033[36m Subrek Yt \033[1;37mFAHX7NON_EXPLOIT \033[36m cuk :v")
    time.sleep(1)
    os.system("xdg-open Belum ada ya heheheh")
    time.sleep(3)
    print ("\033[1;37m[\033[1;30m2\033[1;37m] \033[36m Join \033[1;37mDark Club \033[36m cuk :v")
    time.sleep(1)
    os.system("xdg-open Di ganti tele aja deh heheh https://t.me/DDOSTEAMXYZ")
    time.sleep(3)
    os.system("clear")
...
def mr_dark_input():
    ...
    if subs_mr_dark == "1":
         ...
         print ("\033[1;30m<════════════[\033[1;33;41m • \033[1;37mSTATUS \033[1;33m• \033[0m\033[1;30m]══════════════>")
         for i in range(int(jumlah)):
             if 'Anda sudah melakukan 3 kali pengiriman kode' in FAHX7NONEXEX:
         ...
         os.system("xdg-open di ganti tele aja hehh https://t.me/DDOSTEAMXYZ")
         print ("")
    else:
         time.sleep(2)
...
def banner_anjay_subs_mr_dark():
    ...
    print ("   \033[36m╚═╝\033[1;37m┴  ┴ ┴┴ ┴     \033[36m╚═╝\033[1;37m└─┘└┴┘")
    print ("")
    print ("    \033[1;37m\033[31m>\033[1;37m YouTube\033[31m:\033[1;37m\033[1;37m Di banned🗿 ")
    print ("    \033[1;37m\033[31m>\033[1;37m Github\033[31m:\033[1;37m\033[1;37m github.com/Fahreza1212")
    print ("")
